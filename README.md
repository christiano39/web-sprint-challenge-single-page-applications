...
The useRouteMatch hook is used to access the path of the url without having to expicitly know what it should be.

1. How would you explain form validation to someone who has never programmed before?

Form validation makes sure that you can't submit any kind of data that the developer doesn't want you to submit.

1. In 1-2 sentences, define end to end testing.

End to end testing is when you simulate a user actually navigating and using your site.
